...
const twilioAccountSid = defineSecret("TWILIO_TEST_ACCOUNT_SID");
const twilioAuthToken = defineSecret("TWILIO_TEST_AUTH_TOKEN");


// --- Callable Function: sendTestSms ---
export const sendTestSms = onCall({ secrets: [twilioAccountSid, twilioAuthToken] }, async (request) => {
  ...
  const twilioSmsNumber = "+15005550006";
  ...
  try {
    ...
    await client.messages.create({
      ...
      from: twilioSmsNumber, // Your test Twilio SMS number
      body: messageBody,
    });
...
// --- Callable Function: verifyTestSmsCode (No changes needed) ---
export const verifyTestSmsCode = onCall(async (request) => {
