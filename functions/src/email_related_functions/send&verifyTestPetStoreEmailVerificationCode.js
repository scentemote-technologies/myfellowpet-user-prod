...
export const sendTestPetStoreEmailVerificationCode = onCall(
  { secrets: [smtpHost, smtpPort, smtpUser, smtpPass], region: 'asia-south1', cors: true },
  async (req) => {
...
export const verifyTestPetStoreEmailCode = onCall(
