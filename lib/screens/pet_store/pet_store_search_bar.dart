...
class PetStoreLiveSearchBar extends StatefulWidget {
  ...
  @override
  _PetStoreLiveSearchBarState createState() => _PetStoreLiveSearchBarState();
}

class _PetStoreLiveSearchBarState extends State<PetStoreLiveSearchBar> {
